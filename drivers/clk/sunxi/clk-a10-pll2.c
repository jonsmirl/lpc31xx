...
{
	/*
	 * There is only two interesting rates for audio, the rest isn't
	 * really usable due to accuracy concerns. Therefore, we specifically
	 * round to those rates here
	 */
	if (rate < 22579200)
		return -EINVAL;
